...
from src import ChamferDistance, FPSSampler, RandomSampler, SampleNet, SampleNetPlus, SampleNetPN
...
def options(argv=None, parser=None):
    ...
    parser.add_argument('--sampler', required=True, choices=['fps', 'samplenet', 'random', 'none', 'samplenetplus', 'samplenetpn'], type=str,
...
class Action:
    ...
    def create_model(self):
        ...
        if self.SAMPLER in ["samplenet", "samplenetplus", "samplenetpn"]:
            SamplerNetwork = {
                "samplenet": SampleNet,
                "samplenetplus": SampleNetPlus,
                "samplenetpn": SampleNetPN,
            }.get(self.SAMPLER)
